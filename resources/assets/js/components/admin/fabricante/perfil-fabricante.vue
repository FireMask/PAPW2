            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <h3 class="profile-username text-center">{{ fabricante.nombre_comercial }}</h3>
                        <p class="text-muted text-center">{{ fabricante.nombre }}</p>

                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Fecha de registro</b> <p class="pull-right text-muted">{{ fabricante.created_at | fecha }}</p>
                            </li>
                        </ul>
    ...
    export default {
        ...
        methods: {
            ...
            borrar: function() {
                ...
                this.$http.post('/fabricante/' + this.fabricante.idFabricante, data).then(response => {
                    this.cerrar();
                });
            }
        },
